    ...
    <table style="border: 1px solid #C0C0C0; background-image: url('Images/bg.jpg'); " 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td align="left">
                <asp:TextBox ID="TextBox1" tooltip="1= typical angina, 2= atypical angina, 3= non-anginal pain, 4= asymptomatic" runat="server" CssClass="style12" 
        ...
        <tr>
            ...
            <td class="style9" align="left" >
                <asp:TextBox ID="TextBox2" tooltip="sugar > 120 mg/dl (1 = true; 0 = false)" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox3" tooltip=" 0= normal, 1= having ST-T wave abnormality (T wave inversions and/or ST elevation or depression of > 0.05 mV), 2= showing probable or definite left ventricular hypertrophy by Estes' criteria" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox4" tooltip="(1 = yes; 0 = no)" runat="server" CssClass="style12" 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox5" tooltip=" the slope of the peak exercise ST segment(1= upsloping, 2= flat, 3= downsloping" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox6" tooltip="No. of Major Vessels (0-3) colored by flourosop" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox7" tooltip="3= normal; 6= fixed defect; 7= reversable defect" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox8" tooltip="Resting Blood Pressure (in mm Hg on admission to the hospital)" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox9" tooltip=" serum cholestoral in mg/dl" runat="server" CssClass="style12" 
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox10" tooltip="Maximum heart rate achieved" runat="server" CssClass="style12" 
                    placeholder="Thalach" required="Required" TextMode="SingleLine" Width="100%"></asp:TextBox>
            </td>
            <td width="33%" class="style14">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="right" class="style13">
                &nbsp;</td>
            <td>
                <asp:TextBox ID="TextBox11" tooltip="ST depression induced by exercise relative to rest" runat="server" CssClass="style12" 
                    placeholder="Oldpeak" required="Required" TextMode="SingleLine" Width="100%"></asp:TextBox>
            </td>
            <td width="33%" class="style14">
                &nbsp;</td>
        </tr>
