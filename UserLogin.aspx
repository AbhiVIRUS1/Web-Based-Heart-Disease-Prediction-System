            ...
            <tr>
                <td width="50%" 
                    ...
                    <table class="style3">
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="Button1" runat="server" Font-Bold="False" Font-Size="14pt" style="font-family: calibri" Text="Login &gt;" OnClick="Button1_Click" Width="100%"></asp:Button>
                        ...
                        <tr>
                            <td align="center">
                                <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" 
                                    Font-Size="Large" Font-Underline="False" PostBackUrl="~/Register.aspx" 
                                    style="font-family: calibri" onClientclick="LinkButton1_Click" 
                                    onclick="LinkButton1_Click">SignUp</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </td>
